...
/**
 * Helper class to evaluate precision, recall and F1 score of binary
 * classifiers.
 */
public class LossEvaluator {
    ...
    /**
     * Constructs a new LossEvaluator with the following (initially empty)
     * fields: <ul> <li>{@code tp}: the number of true positives </li>
