 ...
 * The set of all POS tags can be found at <a
 * href="http://www.ling.upenn.edu/courses/Fall_2003/ling001/penn_treebank_pos.html">www.ling.upenn.edu/courses/Fall_2003/ling001/penn_treebank_pos.html</a>.
 */
public class PosHelper {
    ...
    static {
        ...
        posMapper.put(
            "JJ", Arrays.asList("JJ", "JJR", "JJS", "WRB", "RB", "RBR", "RBS"));
     ...
     * @param propbankEntry wheter the corresponding instance is a PropBank
     * frameset. If so, any unmapped POS tag gets mapped to {@link
     * PosHelper#POS_ANY}. Otherwise, it is returned as is.
    ...
    /**
     * This function maps a POS tag string to the corresponding WordNet POS
     * instance
     * @param pos the POS tag string
     * @return the corresponding WordNet POS instance or null if no such
     * instance is found
     */
    public static POS mapPosToWordNet(String pos) {
        if (posMapper.get("NN").contains(pos))
            return POS.NOUN;
        if (posMapper.get("VB").contains(pos)
            || posMapper.get("VBC").contains(pos) || pos.equals("VBN")
            || pos.equals("VBG"))
            return POS.VERB;
